<template>
    <div>
      ...
      <div style="display: flex; justify-content: center;">
        <v-img src="@/assets/logo.png" style="max-width: 15%;"></v-img>
      </div>
      <div class="login-container">
        ...
        <div v-if="!user">
          ...
          <form @submit.prevent="login">
            ...
            <p><router-link to="/SellerSignup">JOIN</router-link></p>
          </form>
        </div>
        <div v-else>
          <!-- 사용자가 로그인되어 있는 경우 -->
      ...
      <div class="text-center">
        <v-img src="@/assets/qrcode.png" style="max-width: 7%; border: 2px solid green;" class="mx-auto"></v-img>
        <br>
        <p>APP DOWNLOAD</p>
